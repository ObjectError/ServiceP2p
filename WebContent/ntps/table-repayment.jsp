                                    ...
                                    <thead>
                                        ...
                                        <tbody>
											<tr>
												...
												<td>${repayy.rstate}</td>
												<td>${repayy.rip}</td>
												<td><a href="income/openUserEdit/${repayy.rid}"> <span class="glyphicon glyphicon-list-alt"></span>修改</a>|
													<a href="income/delete/${repayy.rid}"><span class="glyphicon glyphicon-trash"></span>删除</a></td>
											</tr>
											</tbody>
										</c:forEach>
                                    </thead>
