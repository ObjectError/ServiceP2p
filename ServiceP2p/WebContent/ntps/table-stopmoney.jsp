...
<html>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="fabiao/list" title="Sample page 1">发标标</a>
                </li>
                 <li class="pull-right">
                            ...
                            <div class="body-nest" id="Footable">
                                <table class="table-striped footable-res footable metro-blue" data-page-size="7">
                                    <thead>
                                        ...
                                        <c:forEach items="${listStopmoney}" var="stopmoney">
                                        <tbody>
											<tr>
												<td>${stopmoney.user.suname}</td>
												<td>${stopmoney.smtype}</td>
												<td>${stopmoney.smorder}</td>
												<td>${stopmoney.smmoney}</td>
												<td>
													<c:if test="${stopmoney.smstate==1}">
														已冻结
													</c:if>
													<c:if test="${stopmoney.smstate==2}">
														解冻
													</c:if>
												</td>
												<%-- <td>
    ...
    $(document).ready(function(){
    	$('#likebutton').click(function(){
    		...
    		parent.window.location="${Pagecontext.request.contextPath}likeStopmoney?user.suname="+name;
    	});
    });
    </script>
    <script type="text/javascript">
