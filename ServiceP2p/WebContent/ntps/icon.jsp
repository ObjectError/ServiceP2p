                    ...
                    <div class="col-sm-12">
                        <div class="nest" id="DripClose">
                            ...
                            <div class="body-nest" id="Drip">
                                <p class="lead well">Vector line-icon font by <a href="http://amitjakhu.com">Amit Jakhu</a>. Version 1.0
                                </p>
                    ...
                    <div class="col-sm-12">
                        <div class="nest" id="WeatherClose">
                            ...
                            <div class="body-nest" id="Weather">
                                <section data-valign="center" data-cols="1" data-name="preview">
                                    <p class="lead well">The Weather Icons project created and maintained by <a href="http://www.twitter.com/Erik_UX">Erik Flowers</a>. Original artwork by <a href="http://www.twitter.com/artill">Lukas Bischoff.</a>
                                    </p>
                                    <div class="entypo-tooltip">
                                        <ul>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="entypoClose">
                            ...
                            <div class="body-nest" id="entypo">
                                <p class="lead well">A set of 250+ carefully crafted pictograms by <a target="_blank" href="http://danielbruce.se/">Daniel Bruce</a>. To use with single element use this
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="fontClose">
                            ...
                            <div class="body-nest" id="font">
                                ...
                                <p class="lead well">The iconic font designed for use with Twitter Bootstrap by <a target="_blank" href="http://fortawesome.github.com/Font-Awesome/">Dave Gandy</a>.Avant comes baked with <a href="http://fortawesome.github.io/Font-Awesome/">Font Awesome 4.0.1</a>, which provides you with scalable vector icons that can instantly be customized &mdash; size, color, drop shadow, and anything that can be done with the power of CSS.</p>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="makiClose">
                            ...
                            <div class="body-nest" id="maki">
                                <p class="lead well">It's a clean point of interest icon set made for web cartography by <a target="_blank" href="http://mapbox.com/">MapBox</a>.</p>
                                <section data-valign="center" data-cols="1" data-name="preview">
                                    <div class="entypo-tooltip" style="color:#3498DB">
                                        <ul>
                                            <li class="maki-aboveground-rail" data-placement="right" title="aboveground-rail"></li>
